...
func convert_api_Daemon_To_v1beta3_Daemon(in *api.Daemon, out *Daemon, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
	...
	if err := convert_api_DaemonSpec_To_v1beta3_DaemonSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := convert_api_DaemonStatus_To_v1beta3_DaemonStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}

func convert_api_DaemonList_To_v1beta3_DaemonList(in *api.DaemonList, out *DaemonList, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
	...
	if in.Items != nil {
		...
		for i := range in.Items {
			if err := convert_api_Daemon_To_v1beta3_Daemon(&in.Items[i], &out.Items[i], s); err != nil {
				return err
			}
		}
	} else {
...
func convert_api_DaemonSpec_To_v1beta3_DaemonSpec(in *api.DaemonSpec, out *DaemonSpec, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func convert_api_DaemonStatus_To_v1beta3_DaemonStatus(in *api.DaemonStatus, out *DaemonStatus, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func convert_v1beta3_Daemon_To_api_Daemon(in *Daemon, out *api.Daemon, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
	...
	if err := convert_v1beta3_DaemonSpec_To_api_DaemonSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := convert_v1beta3_DaemonStatus_To_api_DaemonStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}

func convert_v1beta3_DaemonList_To_api_DaemonList(in *DaemonList, out *api.DaemonList, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
	...
	if in.Items != nil {
		...
		for i := range in.Items {
			if err := convert_v1beta3_Daemon_To_api_Daemon(&in.Items[i], &out.Items[i], s); err != nil {
				return err
			}
		}
	} else {
...
func convert_v1beta3_DaemonSpec_To_api_DaemonSpec(in *DaemonSpec, out *api.DaemonSpec, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func convert_v1beta3_DaemonStatus_To_api_DaemonStatus(in *DaemonStatus, out *api.DaemonStatus, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func init() {
	err := api.Scheme.AddGeneratedConversionFuncs(
		...
		convert_api_DaemonList_To_v1beta3_DaemonList,
		convert_api_DaemonSpec_To_v1beta3_DaemonSpec,
		convert_api_DaemonStatus_To_v1beta3_DaemonStatus,
		convert_api_Daemon_To_v1beta3_Daemon,
		...
		convert_v1beta3_DaemonList_To_api_DaemonList,
		convert_v1beta3_DaemonSpec_To_api_DaemonSpec,
		convert_v1beta3_DaemonStatus_To_api_DaemonStatus,
		convert_v1beta3_Daemon_To_api_Daemon,
