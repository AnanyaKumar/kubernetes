...
func deepCopy_v1beta3_Daemon(in Daemon, out *Daemon, c *conversion.Cloner) error {
	if err := deepCopy_v1beta3_TypeMeta(in.TypeMeta, &out.TypeMeta, c); err != nil {
		return err
	}
	if err := deepCopy_v1beta3_ObjectMeta(in.ObjectMeta, &out.ObjectMeta, c); err != nil {
	...
	if err := deepCopy_v1beta3_DaemonSpec(in.Spec, &out.Spec, c); err != nil {
		return err
	}
	if err := deepCopy_v1beta3_DaemonStatus(in.Status, &out.Status, c); err != nil {
		return err
	}
	return nil
}

func deepCopy_v1beta3_DaemonList(in DaemonList, out *DaemonList, c *conversion.Cloner) error {
	if err := deepCopy_v1beta3_TypeMeta(in.TypeMeta, &out.TypeMeta, c); err != nil {
		return err
	}
	if err := deepCopy_v1beta3_ListMeta(in.ListMeta, &out.ListMeta, c); err != nil {
	...
	if in.Items != nil {
		...
		for i := range in.Items {
			if err := deepCopy_v1beta3_Daemon(in.Items[i], &out.Items[i], c); err != nil {
				return err
			}
		}
	} else {
...
func deepCopy_v1beta3_DaemonSpec(in DaemonSpec, out *DaemonSpec, c *conversion.Cloner) error {
	if in.Selector != nil {
...
func deepCopy_v1beta3_DaemonStatus(in DaemonStatus, out *DaemonStatus, c *conversion.Cloner) error {
...
func init() {
	err := api.Scheme.AddGeneratedDeepCopyFuncs(
		...
		deepCopy_v1beta3_Daemon,
		deepCopy_v1beta3_DaemonList,
		deepCopy_v1beta3_DaemonSpec,
		deepCopy_v1beta3_DaemonStatus,
